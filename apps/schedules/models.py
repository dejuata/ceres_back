...
class Schedule(AbstractTableMeta, models.Model):
    ...
    zone = models.ForeignKey(Zone, on_delete=models.PROTECT, verbose_name="Zona de Campo")
    labor = models.ForeignKey(Labor, on_delete=models.PROTECT, verbose_name="Labor de Campo")
    operator = models.ForeignKey(User, on_delete=models.PROTECT, verbose_name="Operario")
